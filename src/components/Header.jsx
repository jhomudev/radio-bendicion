...
function Header () {
  ...
  const menuItems = [
    { name: 'Home', section: homeSection.current },
    { name: 'Programación', section: progSection.current },
    { name: 'Contactos', section: contactsSection.current },
    { name: 'Nosotros', section: aboutSection.current }
  ]
